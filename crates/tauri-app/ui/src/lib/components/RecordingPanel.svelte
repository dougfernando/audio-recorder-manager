<script>
    ...
    const qualities = [
        ...
        {
            value: "standard",
            label: "Standard (44.1kHz)",
            description: "10 MB/min",
        },
        {
            value: "professional",
            label: "Professional (48kHz)",
            description: "11 MB/min",
        },
    ...
    onMount(async () => {
        ...
        unlistenTrayRecording = await listen(
            "tray-start-recording",
            async (event) => {
                console.log("Tray recording event received:", event.payload);
                const duration = event.payload?.duration || 300;
    ...
    <div class="setting-group">
        ...
        <div class="duration-pills">
            {#each durationPresets as preset}
                <button
                    class="duration-pill {$selectedDuration === preset &&
                    !$isManualMode
                        ? 'active'
                        : ''}"
                    on:click={(event) => {
    ...
    <div class="level-meters">
        <div class="level-meter-group">
            <div class="level-meter-header">
                ...
                <div
                    class="level-indicator {loopbackLevel > 0.01
                        ? 'active'
                        : ''}"
                >
            ...
            <div class="level-meter-bar">
                <div
                    class="level-meter-fill {loopbackLevel > 0.8
                        ? 'clipping'
                        : ''}"
        ...
        <div class="level-meter-group">
            <div class="level-meter-header">
                ...
                <div
                    class="level-indicator {microphoneLevel > 0.01
                        ? 'active'
                        : ''}"
                >
            ...
            <div class="level-meter-bar">
                <div
                    class="level-meter-fill {microphoneLevel > 0.8
                        ? 'clipping'
                        : ''}"
